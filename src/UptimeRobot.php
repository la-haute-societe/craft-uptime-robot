...
class UptimeRobot extends Plugin
{
    ...
    public function init()
    {
        ...
        // TODO: Create a Twig extension to output autogenerated keyword checker
    ...
    {
        $permissions = [
            'uptime-robot:add-monitor'    => [
                'label' => Craft::t('uptime-robot', 'Add monitor'),
            ],
            'uptime-robot:view-monitors'  => [
                'label' => Craft::t('uptime-robot', 'View monitors'),
            ],
            'uptime-robot:edit-monitor'   => [
                'label' => Craft::t('uptime-robot', 'Edit monitors'),
            ],
            'uptime-robot:remove-monitor' => [
                'label' => Craft::t('uptime-robot', 'Remove monitors'),
            ],
        ];
        if (Craft::$app->getIsMultiSite() === true) {
            foreach (Craft::$app->getSites()->getAllSites() as $site) {
                $permissions['uptime-robot:view-monitors']['nested']['uptime-robot:view-monitors:' . $site->id] = [
                    'label' => $site->name,
                ];
                $permissions['uptime-robot:edit-monitor']['nested']['uptime-robot:edit-monitor:' . $site->id] = [
                    'label' => $site->name,
                ];
                $permissions['uptime-robot:remove-monitor']['nested']['uptime-robot:remove-monitor:' . $site->id] = [
                    'label' => $site->name,
                ];
            }
        }
